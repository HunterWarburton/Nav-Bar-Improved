var links = [{label: 'Sign In', bg: '#ff0000',
              id: "signin_link", onclick: 'signin.html'}, 
             {label: 'About', bg: '#00ff00',
              id: "about_link", onclick: 'about.html'}, 
             {label: 'Mission', bg: '#0000ff',
              id: "mission_link", onclick: 'mission.html'}, ];
var windowHeight = window.innerHeight;
if(windowHeight === 0) windowHeight = 238;
var radius = windowHeight*0.2,
...
function styleLinks() {
  for (var i=0, l=links.length; i<l; i++) {
    ...
    link.style.top = (windowHeight/4) - (windowHeight*0.1)+borderSize+'px';
    ...
    hover.style.top = (windowHeight/4) - (windowHeight*0.1)+borderSize +'px';
